...
__     | _|_ o |_)|_     o (_|
||||_| |  |_ | |_)|  ___ | __|
\e[1;31mcontact: we.me+62089647046341\e[1;37m
'''
figlet Tn.PutraGans | lolcat

echo llllllllllllllllllllllllllllllllllllllllllllllllllllll | lolcat
echo Yt:PARAMEX CHANEL | lolcat
echo blog:http://mr-x-koclok.blogspot.com | lolcat
echo llllllllllllllllllllllllllllllllllllllllllllllllllllll | lolcat
